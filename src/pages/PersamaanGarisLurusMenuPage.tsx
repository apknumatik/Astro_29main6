...
const subTopics = [
  { label: "Grafik Persamaan Garis Lurus", path: "" },
  { label: "Gradien (Kemiringan Garis)", path: "" },
  { label: "Menentukan Persamaan Garis Lurus", path: "" },
  { label: "Hubungan 2 Garis", path: "" },
  { label: "Aplikasi Persamaan Garis pada Soal Kontekstual", path: "" },
];
